...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_chips_backup_bucket"></a> [chips\_backup\_bucket](#module\_chips\_backup\_bucket) | terraform-aws-modules/s3-bucket/aws | 2.11.1 |
| <a name="module_chips_backup_bucket_policy"></a> [chips\_backup\_bucket\_policy](#module\_chips\_backup\_bucket\_policy) | git@github.com:companieshouse/terraform-modules//aws/s3_cross_account_policy?ref=tags/1.0.99 |  |
